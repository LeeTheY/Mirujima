...
| 멤버십 | Toss 테스트 결제와 서버 entitlement 판정 | 테스트 모드 구현 |
...
| AI 추천·가족 요약 | 기존 AI Edge Function과 entitlement 기반 구조 | 부분 구현 — 현재 Web CTA와 v3 기능 흐름 연결 필요 |
...
- Web의 AI 스마트 추천 버튼과 v3 AI 코칭 흐름은 아직 실행 경로에 연결되지 않았습니다.
